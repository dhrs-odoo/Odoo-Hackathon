 ...
 <!-- end HEAD--> 
  <body>
    ...
    <!--navbar-->
      ...
      <div class="page-head">
          <h2 class="page-head-title">Bed Rolls</h2>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="card card-table">
                <div class="card-header">Bed Rolls
                </div>
                <hr >
                <div class="card-body">
              ...
              <div class="widget widget-tile">
                <div class="data-info">
                  <?php
                    ...
                    $stmt->close();
                  ?>
                  <div class="avl">Available Bed Rolls</div>
                    <style>
                        .avl{
                            text-align: right;
                            margin-right: -135px;
            ...
            <p class="text-center" id="btn">
                          <input class="btn btn-space btn-success" value ="Add Bed Rolls " name = "Bedrolls" type="submit">
