 ...
 <!-- end HEAD--> 
  <body>
    ...
    <!--navbar-->
      ...
      <div class="page-head">
          <h2 class="page-head-title">Dinner Meals</h2>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="card card-table">
                <div class="card-header">Dinner Meals
                </div>
                <hr >
                <div class="card-body">
              ...
              <div class="widget widget-tile">
                <div class="data-info">
                  <?php
                    ...
                    $stmt->close();
                  ?>
                  <div class="avl">Available Dinner Meals</div>
                    <style>
                        .avl{
                            text-align: right;
                            margin-right: -135px;
            ...
            <p class="text-center" id="btn">
                          <input class="btn btn-space btn-success" value ="Add Meals" name = "dinner" type="submit">
