 ...
 <!-- end HEAD--> 
  <body>
    ...
    <!--navbar-->
      ...
      <div class="page-head">
          <h2 class="page-head-title">BreakFast Meal</h2>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="card card-table">
                <div class="card-header">BreakFast Meal
                </div>
                <hr >
                <div class="card-body">
              ...
              <div class="widget widget-tile">
                <div class="data-info">
                  <?php
                    ...
                    $stmt->close();
                  ?>
                  <div class="avl">Available Meals</div>
                    <style>
                        .avl{
                            text-align: right;
                            margin-right: -115px;
            ...
            <p class="text-center" id="btn">
                          <input class="btn btn-space btn-success" value ="Add Meals " name = "breakfast" type="submit">
